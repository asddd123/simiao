...
CREATE TABLE `eps_config` (
  ...
  KEY `lang` (`lang`)
) ENGINE=MyISAM AUTO_INCREMENT=1172 DEFAULT CHARSET=utf8;_ZDB_LINE_ENDER_
...
<p>so，不要再犹豫，新时代做企业营销，首选蝉知门户系统，靠谱！</p>','admin','demo','2014-08-25 14:31:29','2015-03-03 14:34:24','normal','126','0','1','','','zh-cn','','',''),('2','演示商品一','','','0','','蝉知','','','','','8888.00','0','0.01','0','','<p>蝉知在线(以下简称云蝉知)是由青岛息壤网络信息有限公司（以下简称青岛息壤）提供的在线建站服务。</p>','<p>云蝉知在线(以下简称云蝉知)是由青岛息壤网络信息有限公司(以下简称青岛息壤)提供的在线建站服务。若您申请云蝉知帐户并使用相应服务，您必须先同意此协议：</p>
<h4>一、服务条款的确认和接纳<br />
</h4>
...
对于因不可抗力造成的服务中断、链接受阻或其他缺陷(包括但不限于自然灾害、社会事件以及因网站所具有的特殊性质而产生的包括系统崩溃、数据丢失、黑客攻
击、电信部门技术调整导致的影响、政府管制而造成的暂时性关闭在内的任何影响网络正常运营的因素)，云蝉知网站不承担任何责任，但将尽力减少因此而给会员
造成的损失和影响；<br/>(4) 云蝉知网站对用户因使用云蝉知服务而造成的损失不负法律责任。不论什么情况下对用户因使用云蝉知服务而造成的直接、间接、偶尔的、特殊的惩罚性的损害或其他一切损害概不负法律责任；<br/>(5) 如因云蝉知原因，造成服务的不正常中断，青岛息壤不承担任何责任，青岛息壤也不承担由此致使会员蒙受的其它方面的连带损失；</p><h4>八、隐私与保密<br/></h4><p>(1) 您注册时所填写的个人信息仅限于青岛息壤与您之间联系使用，青岛息壤不得将其用于商业目的。<br/>(2) 您通过云蝉知产生的任何数据都属于您所有。除非您主动要求我们协助您排查问题，否则青岛息壤的所有员工无权查看、编辑、复制、删除您的任数据。</p><h4>九、最终解释权<br/></h4><p>青岛息壤网络信息有限公司对云蝉知保有所有活动、限制等的最终解释权。</p>','admin','admin','2014-08-25 15:06:50','2018-04-28 16:34:04','normal','56','0','2','','','zh-cn','213213','23432423','222'),('3','','','0','','','','','','','0.00','0','0.00','0','','','','admin','','2018-04-24 17:59:16','2018-04-24 17:59:16','normal','4','0','3','','','zh-cn','423412','32423432',''),('4','','','0','','','','','','','0.00','0','0.00','0','','','<p>111</p>','admin','admin','2018-04-25 17:32:54','2018-04-28 16:33:57','offline','0','0','4','','','zh-cn','421421','432432432',''),('5','','','0','','','','','','','0.00','0','0.00','0','','','','admin','','2018-04-28 16:47:23','2018-04-28 16:47:23','normal','6','0','5','','','zh-cn','','',''),('12','','','0','','','','','','','0.00','0','0.00','0','','','','admin','','2018-04-28 17:08:27','2018-04-28 17:08:27','normal','11','0','12','','','zh-cn','','',''),('2342342','','','0','','','','','','','0.00','0','0.00','0','','','','admin','','2018-04-28 17:50:52','2018-04-28 17:50:52','normal','40','0','65535','','','zh-cn','','','');_ZDB_LINE_ENDER_
