...
<?php echo js::set('objectType', $objectType); ?>
      ...
      <?php foreach($comments as $number => $comment): ?>
        ...
        <div class='w-p100 panel comment-item comment-panel' id="comment<?php echo $comment->id;?>">
          <div class='panel-heading content-heading'>
            ...
            <?php echo html::a($control->createLink('message', 'reply', "commentID=$comment->id"), $lang->message->reply, "class='pull-right' data-toggle='modal' data-type='iframe' data-icon='reply' data-title='{$lang->comment->reply}'"); ?>
...
<div class='panel'>
  ...
  <div class='panel-body'>
    <form method='post' class='form-horizontal' id='commentForm' action="<?php echo $control->createLink('message', 'post', 'type=comment'); ?>">
          ...
          <div class='col-sm-11'>
            <span class='signed-user-info'>
              ...
              <?php if($control->session->user->email != ''){ ?>
                ...
                <span class='text-muted'>&nbsp;(<?php echo str2Entity($control->session->user->email); ?>)</span>
