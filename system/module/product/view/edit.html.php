  ...
  <div class='panel-body'>
    <form method='post' id='ajaxForm'>
      <table class='table table-form'>
        ...
        <tr>
          <th><?php echo $lang->product->number;?></th>
          <td colspan='2'>
            <div class='row order'>
...
<!--            </div>-->
        ...
        <tr>
            <th><?php echo $lang->product->userName;?></th>
            <td><?php echo html::input('userName', $product->userName, "class='form-control'");?></td>
        </tr>
        <tr>
            <th><?php echo $lang->product->startDate;?></th>
            <td><?php echo html::input('startDate', $product->startDate ? date('Y-m-d', $product->startDate) : null, "class='form-control form-date' readonly");?></td>
            <td><?php echo html::commonButton('删除', "delStart") ?></td>
        </tr>
        <tr>
            <th><?php echo $lang->product->endDate;?></th>
            <td><?php echo html::input('endDate', $product->endDate ? date('Y-m-d', $product->endDate) : null, "class='form-control form-date' readonly");?></td>
            <td><?php echo html::commonButton('删除', "delEnd") ?></td>
        </tr>
        <tr>
